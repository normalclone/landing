    ...
    return (
        <>
            <Script
                ...
                strategy="afterInteractive" /><nav data-animate className="navbar navbar-expand-lg bg-surface nav-border py-2 fixed-top shadow-sm fade-in">
                <div className="container">
                    ...
                    <div className="collapse navbar-collapse" id="navbarMain">
                        <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item">
                                <Link className="nav-link fw-semibold" href="#leaderboard">
                                    Xếp hạng
                                </Link>
                            </li>
                            <li className="nav-item">
